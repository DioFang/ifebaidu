...
window.onload=function(){
	(function(){
		...
		addEvent(names,"blur",function(){
			nameWarn.innerHTML=check.checkName(name,value);
			if (nameWarn.innerHTML=="名称可用") {
				name.style.borderColor="#5fb844";
				nameWarn.style.color="#5fb844";
			}
			else{
				name.style.borderColor="#de0011";
